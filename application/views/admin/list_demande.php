				...
				<div class="container-fluid">
				  <!-- Page Heading -->
					<div class="d-sm-flex align-items-center justify-content-between mb-4">
						<h1 class="h3 mb-0 text-title">DETAILS DEMANDE D'EMPLOIS</h1>
					...
					<div class="row">
									...
									<div class="job-header">
										...
										?>
											<ul class="jbdetail" style="position:relative;left:-30px;">
												<li class="row">
													<div class="col-md-4 col-xs-5"  style="color:#211212;font-size:18px;font-weight:bold">Poste</div> 
													<div class="col-md-8 col-xs-7"><span style="color:#79705d;font-size:18px;font-weight:bold"><?php echo $offre->poste; ?></span></div>
												</li> <hr> 
												<li class="row">
												...
												<li class="row">
													<div class="col-md-6 col-xs-5">Lettre de motivation requise</div>
						...
						<div class="col-lg-6 col-sm-12 mb-4">
							<div class="card shadow mb-4 x1">
								<div class="card-header  bg-gray-900 bg-gradient-warning py-2">
									<h6 style="color:#fafafa" class="m-0 font-weight-bold"><center>ACTION</center></h6>
								</div>
								<div class="card-body bg-gray-900"> 
									<div class="contentbox "> 
										<center><a href="<?php echo site_url("Admin/accepter_demande/".$demande->idDemande.'/'.$offre->nbPoste.'/'.$offre->nbPosteAttribue.'/'.$offre->idOffre)?>" class="btn btn-success btn-icon-split bg-gradient-success">
											<span class="icon text-gray-100">
												<i class="fas fa-check"></i>
											</span>
											<span class="text">&nbsp; ACCEPTER LA DEMANDE &nbsp;</span>
										</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
										<a href="<?php echo site_url("Admin/rejeter_demande/".$demande->idDemande) ?>"  class="btn btn-danger btn-icon-split bg-gradient-danger">
											<span class="icon text-gray-100">
												<i class="fas fa-trash"></i>
											</span>
											<span class="text">&nbsp; REJETER LA DEMANDE &nbsp;</span>
										</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </center>
									</div>
								</div>
							</div>
								...
								<div class="col-lg-12 col-sm-12 mb-4"> 
									<div class="card shadow">
										<div class="card-header bg-gray-300 py-2">
											<h6 class="m-0 font-weight-bold text-gray-900">CANDIDAT</h6>
										</div>
										<div class="card-body">
											<div class="row">								
												...
												if(!empty($candidat->CV)) echo'<a href="'.resume_url("".$candidat->CV).'" target="_blank"  class="btn btn-primary btn-icon-split bg-gradient-primary"><span class="icon text-gray-100">
													<i class="fas fa-flag"></i>
												</span><span class="text">&nbsp; Voir le CV &nbsp;</span></a>';
												else echo '<p>Le candidat n\'a pas envoyé de CV</p>';
												
												if(!empty($demande->motivationLetter)) echo'&nbsp;&nbsp;&nbsp;<a href="'.lettre_motivation("".$demande->motivationLetter).'" target="_blank"  class="btn btn-primary btn-icon-split bg-gradient-primary"><span class="icon text-gray-100">
													<i class="fas fa-flag"></i>
												</span><span class="text">&nbsp; Voir la lettre de motivation </span></a>'; 
											echo'</div>
										</div>
									</div>
								</div>
