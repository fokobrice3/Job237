...
<div id="Mainsec" class="col-md-10 col-sm-12">		
	<div class="Block"> 
		<form action="<?php echo site_url('Offer/updateOffer/'.$offre->idOffre); ?>" method="POST" enctype="multipart/form-data">
			<div class="row">
				<div class="col-md-12 col-sm-12">		
					<h5 style="background:#00abe6;"><?php echo $this->lang->line('UpdateJob')?></h5> 
					<div class="col-md-12 col-sm-12 Block-jobs">	 
						...
						<div class="col-md-8 col-sm-12">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="nom" id="nom" placeholder="<?php echo $this->lang->line('EnterName')?>" value="<?php echo $offre->poste; ?>">
						...
						<div class="col-md-4 col-sm-12">
							<div class="form-group">
								...
								<select class="form-control" id="metier" name="metier">
									<option disabled value="">Select Metier</option>
									<?php 
									foreach($list_metier as $row){	
										if($offre->idMetier==$row['idMetier']) $select="selected"; else $select="";
						...
						<div class="col-md-4 col-sm-12">
							<div class="form-group">
								...
								<select class="form-control" id="ctype" name="ctype">  
									<option <?php if($offre->contrat=="CDD") echo"selected"; ?> value="CDD">CDD</option>
									<option <?php if($offre->contrat=="CDI") echo"selected"; ?> value="CDI">CDI</option> 
								</select>
							</div>
						</div>
						<div class="col-md-4 col-sm-12">
							<div class="form-group">
								...
								<input id="duree" name="duree" class="form-control" min="1" max="180" value="<?php echo $offre->duree; ?>" type="number">
						...
						<div class="col-md-4 col-sm-12">
							<div class="form-group">
								...
								<input id="reference" name="reference" class="form-control" value="<?php echo $offre->reference; ?>" type="text" readonly>	 							
							</div>
						</div>
						...
						<div class="col-md-4 col-sm-12">
							<div class="form-group">
								...
								<select class="form-control" id="nbPoste" name="nbPoste">
									...
									for($i=1;$i<=100;$i=$i+1){ 										
										echo '<option value="'.$i.'"';
										if($offre->nbPoste==$i) echo"selected";
										echo '>'.$i.'</option>';
									} 
									?>
								</select> 
						...
						<div class="col-md-4 col-sm-12">
							<div class="form-group">
								...
								<input id="datePub" name="datePub" class="form-control" value="<?php echo $offre->datePublication; ?>" type="" >
						...
						<div class="col-md-4 col-sm-12">
							<div class="form-group">
								...
								<input id="dateFin" name="dateFin" class="form-control" value="<?php echo $offre->dateDepot; ?>" type="" >
						...
						<div class="col-md-4 col-sm-12">
							<div class="form-group">
								...
								<select class="form-control" name="pays" id="pays">
									<option <?php if($offre->pays) echo "selected" ?> disabled value="">Select Country</option>
									<?php						
									foreach ($list_pays as $row){
										if($offre->pays==$row['idPays']) $select='selected'; else $select='';
						...
						<div class="col-md-4 col-sm-12">
							<div class="form-group">
								...
								<select class="form-control" name="region" id="region">
									<option <?php if($offre->region) echo "selected" ?> disabled value="">Select State</option>
									<?php 
									if($idPays!=null){
										foreach ($list_region as $row){
											if($offre->region==$row['idRegion']) $select='selected';else $select='';
						...
						<div class="col-md-4 col-sm-12">
							<div class="form-group">
								...
								<select class="form-control" name="ville" id="ville">
									<option  <?php if($offre->ville) echo "selected" ?> disabled value="">Select City</option>
									<?php 
									if($idVille!=null){
										foreach ($list_ville as $row){
											if($offre->ville==$row['idVille']) $select='selected';else $select='';
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<textarea  value="<?php echo $offre->descriptionOffre; ?>" class="" rows="8" id="edit" name="comment" placeholder="" >  
								<?php echo $offre->descriptionOffre; ?>
								</textarea>
						...
						<div class="col-md-3 col-sm-12">
							<div class="form-group">
								...
								foreach($list_degree as $row){
									...
									if($offre->idNiveauEtude==$row['idNiveauEtude']) echo"selected";
									echo '>'.$row['nom'].'</option>';
								}	
								?>	
								</select>
							...
							<div class="form-group">
								...
								<select class="form-control" id="type_education" name="type_education">									
									...
									<?php foreach($list_type_degree as $row){
										if($offre->idTypeEducation==$row['idTypeEducation']) $select ="selected"; else $select="";
										if($langue=="french") $nom = $row['nom']; else $nom=$row['name'];
										echo '<option '.$select.' value="'.$row['idTypeEducation'].'">'.$nom.'</option>';
										} 
									?>	
								</select>
							</div>
						...
						<div class="col-md-3 col-sm-12">
							<div class="form-group">
								<label class="control-label compagny-label" for="specialite">Spécialité</label>
						...
						<div class="col-md-3 col-sm-12">
							<div class="form-group">
								<label class="control-label compagny-label" for="experience">Expérience (Année)</label>
								<select class="form-control" id="experience" name="experience">									
									<option <?php if($offre->experience==null) echo"selected"; ?> value="">/</option>
									<option <?php if($offre->experience==1) echo"selected"; ?> value="1">1</option>
									<option <?php if($offre->experience==2) echo"selected"; ?> value="2">2</option>
									<option <?php if($offre->experience==3) echo"selected"; ?> value="3">3</option>
									<option <?php if($offre->experience==4) echo"selected"; ?> value="4">4</option>
									<option <?php if($offre->experience==5) echo"selected"; ?> value="5">5</option>
									<option <?php if($offre->experience==6) echo"selected"; ?> value="6">6</option>
									<option <?php if($offre->experience==7) echo"selected"; ?> value="7">7</option>
									<option <?php if($offre->experience==8) echo"selected"; ?> value="8">8+</option>
								</select>
							</div>
						</div>		
						<div class="col-md-3 col-sm-12">
							<div class="form-group">
								...
								<div class="col-md-4 col-sm-6 radioType">
									<input type="radio" id="control_03" name="motivationLetter" value="1" <?php if($offre->motivationLetter) echo"checked"; ?>> 
									<label for="control_03"> 
										<p><?php echo $this->lang->line('Yes')?></p>
									</label>
								</div>
								<div class="col-md-4 col-sm-6 radioType">
									<input type="radio" id="control_04" name="motivationLetter" value="0" <?php if(!$offre->motivationLetter) echo"checked"; ?>> 
						...
						<div class="col-md-3 col-sm-12">
							<div class="form-group">
								...
								<div class="col-md-4 col-sm-6 radioType">
									<input type="radio" id="control_01" name="freelance" value="1" <?php if($offre->Freelance) echo"checked"; ?> > 
									<label for="control_01"> 
										<p><?php echo $this->lang->line('Yes')?></p>
									</label>
								</div>
								<div class="col-md-4 col-sm-6 radioType">
									<input type="radio" id="control_02" name="freelance" value="0" <?php if(!$offre->Freelance) echo"checked"; ?>> 
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<textarea value="<?php echo $offre->descriptionProfil; ?>" class="" rows="8" id="edit2" name="profil" placeholder="" >  
								<?php echo $offre->descriptionProfil;?>	
								</textarea>
...
$(document).ready(function(){ 
	...
	var autocomplete = new SelectPure(".autocomplete-select", {
        ...
        <?php
			$c = explode(',',$offre->listCompetences); 
			$d = array();	
			echo "value:[";			
			for($i=0; $i<sizeof($c);$i++){
				if($i<sizeof($c)-1) echo "'".$c[$i]."',";
				else echo "'".$c[$i]."'";
			}
			echo"],";
		?>		 
