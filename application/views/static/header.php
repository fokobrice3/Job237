<header <?php if($page=="accueil") echo 'style="position:fixed;top:0;height:5px;"'; ?>>
	<!-- Menu Section --> 
	<section data-spy="affix" data-offset-top="150" <?php if($_SESSION['connected']=="yes") echo 'style="margin-bottom:-58px;height:58px;background:rgba(33,33,33,1);border-bottom:5px solid #1e1b1d;"'; ?>>
		<div class="col-md-2 col-sm-2"> 
			<a href="<?php echo site_url('Welcome/index');?>">
				<h4 class="logo"> 
					<img alt="logo" id="logo" style="width:100px;top:5px;" src="<?php echo img_url('ceo5.png'); ?>"> 
				</h4>
			</a>
		</div>
			...
			<nav class="menu">
				...
				<div class="7">				
					<ul>
						...
						<li class="<?php if($page=="article") echo "active";?>"> <a href="<?php echo site_url('Welcome/Article');?>">Articles</a></li> 
						<?php 
					...
					?>
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a class="secondl" href="<?php echo site_url('LanguageSwitcher/switchLang/english');?>"><?php echo $this->lang->line('English')?></a></li> 
							</ul>
						</li>
					</ul>
				</div>
	...
	<section style="padding-bottom:0px;padding-left:0;padding-right:0;" class="hero13">
		...
		<img src="'.img_url("shape-bg3.png").'" style="position:relative;top:5px;left:0;width: 100%;" alt="shape image" class="img-responsive"/>
	</section>';
	?>
	...
	?>	
	<!-- Banner Section Article Page -->
	<?php if($page=="article") echo'
	<section style="padding-bottom:0px;padding-left:0;padding-right:0;" class="hero15">
		<div style="padding-top:0px;padding-bottom:0px;padding-left: 200px;	padding-right: 200px;">
			<h2 style="top:30px;" class="hero_header"><br>Articles</h2> 
			<p style="top:30px;font-size:1em;" class="tagline2"> &nbsp;&nbsp;&nbsp;'.$this->lang->line('OurArticleMsg').'</p>
		</div>
		<img src="'.img_url("flip-horizontal.png").'" style="position:relative;top:5px;left:0;width:100%" alt="shape image" class="img-responsive" />
	</section>';
	?> 
...
<div id="NavMobile" style="display:none;" >
	<center><img src="<?php echo img_url('ceo5.png'); ?>" alt="Logo" class="logo"/></center>
	<h4>CeoGroup SARL</h4>
	<ul>
		<li class="<?php if($page=="accueil") echo "active";?>"><a href="<?php echo site_url('Welcome/index');?>" ><?php echo $this->lang->line('Home');?></a></li>
		<li class="<?php if($page=="qui_sommes_nous") echo "active";?>"><a href="<?php echo site_url('Welcome/qui_sommes_nous');?>" ><?php echo $this->lang->line('WWA');?></a></li>
...
<!-- SLIDER PARGE ACCUEIL -->
<?php if($page=="accueil"){ 
		echo'
		<section id="hero-section" class="hero-slider-section">
		<div class="owl-carousel owl-theme hero-background-slider custom-indicator">
			<div class="item">
				<div class="slider-bg-content slide_item1">
					<div class="container">
						<div class="row">
							<div class="col-md-5">
								<div class="hero-image">
									<img id="logCeo" src="'.img_url("logo_ceo.png").'" alt="hero-image" class="img-responsive">
								</div>
							</div>
							<div class="col-md-7">
								<div class="hero-content"><br>
									<h1><span>CEO Group SARL</span></h1>
									<p>'.$this->lang->line("MessBan").'</p>
								</div> 
							</div>							
						</div>
					</div>
			...
			if(count($list_pole) > 0){	
				$i=2;
				$color='#da4e32';								
				foreach ($list_pole as $row){ 
					if($langue=="french") { 
						$titre=$row['titreFR']; 
					...
					echo '<div class="item">
							<div class="slider-bg-content slide_item'.$i.'">
								<div class="container">
									<div class="row">
										<div class="col-md-8">
											<div class="hero-content">
												<h1 style="color:'.$color.'">'.$titre.'</h1>
												<p>'.$description.'</p>
											</div> 
										</div>
										<div class="col-md-4">
					...
					$i++;	 		
					if($i==3) $color='#2196f3';	 						
					else if($i==4) $color='#ffd646';	 						
					else if($i==5) $color='#fff';	 						
					else if($i==6) $color='#80b547';   						
					else;																
				}  
			}
		echo '</section>'; 
